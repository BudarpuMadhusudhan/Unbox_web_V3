...
import dbase from "./test/genericUtility/dbUtility"
import loginWorkFlow from './test/workflowLibrary/loginWorkFlow'
...
//---------------------------------------------------------------------------------------------------------------            
    ...
    onComplete: function (exitCode, config, capabilities, results) {
        ...
        rmdir(downloadDir)
        dbase.disconnectDataBaseConnection()
    },
    /**
    ...
    beforeSuite: async function (suite) {
        ...
        await loginWorkFlow.launchApplication(process.env.APP_URL)
    },
    /**
    ...
    afterTest: async function (test, context, { error, result, duration, passed, retries }) {
        ...
        const d=new Date()
        if (!passed) {
            const filePath = path.resolve('./test/reports/screenshots', `${d.getMilliseconds()}_sc.png`);
